    ...
    <div className=" bg-white">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="max-w-xl">
          ...
          <h1 className=" text-base text-primary font-medium">Thank you!</h1>
        ...
        <div className=" mt-10 border-t border-zinc-200">
          <div className=" mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              We at CaseCobra believe that phone case doesn`t only need to look
        ...
        <div
          className="flex space-x-6 overflow-hidden mt-4 rounded-xl bg-gray-900/5 ring-1
        ...
        <div className=" grid grid-cols-2 gap-x-6 py-10 text-sm">
          ...
          <div>
            ...
            <div className=" mt-2 text-zinc-700 ">
              {/*  <address className=" not-italic">
                <span className="block">Price: {formatPrice(amount)}</span>
              </address> */}
            </div>
          </div>
        </div>
        ...
        <div
          className=" grid grid-cols-2 gap-x-6 border-t border-zinc-200 py-10
        text-sm"
        >
          <div>
        ...
        <div className=" space-y-6 border-t border-zinc-200 pt-10 text-sm ">
          ...
          <div className=" flex justify-between">
            ...
            <p className=" text-zinc-700 font-bold">{formatPrice(amount)}</p>
          </div>
        </div>
      </div>
    </div>
